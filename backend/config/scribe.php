...
return [
    ...
    'auth' => [
        ...
        'extra_info' => 'To authenticate, first call the <b>POST /api/auth/login</b> endpoint with your credentials. Use the returned token in the <code>Authorization</code> header as: <code>Bearer {token}</code>',
    ],
